...
MAKE_WEBHOOK   = os.environ["MAKE_WEBHOOK_URL"]   # URL из Make.com
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if msg.forward_from_chat:
        source = msg.forward_from_chat.title or msg.forward_from_chat.username or "неизвестный чат"
    ...
    if session and not msg.forward_date and not msg.forward_from_chat and not msg.forward_from:
